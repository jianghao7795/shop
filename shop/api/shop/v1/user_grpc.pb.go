...
const (
	Shop_Register_FullMethodName = "/api.shop.v1.Shop/Register"
	Shop_Login_FullMethodName    = "/api.shop.v1.Shop/Login"
	Shop_Captcha_FullMethodName  = "/api.shop.v1.Shop/Captcha"
	Shop_Detail_FullMethodName   = "/api.shop.v1.Shop/Detail"
)
